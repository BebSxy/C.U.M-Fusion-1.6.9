...
package me.cum.fusion.features.gui.components;
...
public class Component extends Feature
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Fusion.textManager.drawStringWithShadow(this.getName(), this.x + 3.0f, this.y - 4.0f - NewGui2.getClickGui2().getTextOffset(), -1);
        if (this.open) {
    ...
    public void mouseClicked(final int mouseX, final int mouseY, final int mouseButton) {
        if (mouseButton == 0 && this.isHovering(mouseX, mouseY)) {
            ...
            NewGui2.getClickGui2().getComponents().forEach(component -> {
                if (component.drag) {
