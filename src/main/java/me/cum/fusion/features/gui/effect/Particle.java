...
package me.cum.fusion.features.gui.effect;
...
public class Particle
{
    ...
    public void render(final int mouseX, final int mouseY) {
        ...
        RenderUtil.drawRect(this.pos.x, this.pos.y, this.pos.x + this.size, this.pos.y + this.size, changeAlpha(ColorUtil.toRGBA(Particles.getInstance().particlered.getValue(), Particles.getInstance().particlegreen.getValue(), Particles.getInstance().particleblue.getValue()), this.alpha));
    }
