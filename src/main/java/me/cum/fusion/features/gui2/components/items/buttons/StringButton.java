...
public class StringButton extends Button
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (this.isListening) {
            Fusion.textManager.drawStringWithShadow(this.currentString.getString() + Fusion.textManager.getIdleSign(), this.x + 2.3f, this.y - 1.7f - ClickGuiScreen.getClickGui().getTextOffset(), this.getState() ? -1 : -5592406);
        }
        else {
            Fusion.textManager.drawStringWithShadow((this.setting.getName().equals("Buttons") ? "Buttons " : (this.setting.getName().equals("Prefix") ? ("Prefix  " + ChatFormatting.GRAY) : "")) + this.setting.getValue(), this.x + 2.3f, this.y - 1.7f - ClickGuiScreen.getClickGui().getTextOffset(), this.getState() ? -1 : -5592406);
        }
    }
