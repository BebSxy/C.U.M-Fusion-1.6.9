...
public class Replenish extends Module
{
    ...
    public Replenish() {
        ...
        this.gapStack = (Setting<Integer>)this.register(new Setting("GapStack", (T)16, (T)1, (T)64));
        this.xpStackAt = (Setting<Integer>)this.register(new Setting("XPStack", (T)16, (T)1, (T)64));
        this.crystalStack = (Setting<Integer>)this.register(new Setting("CrystalStack", (T)16, (T)1, (T)64));
