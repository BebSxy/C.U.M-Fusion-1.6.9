...
public class AutoArmor extends Module
{
    ...
    public void onTick() {
        ...
        if (this.timer.passedMs((int)(this.delay.getValue() * Fusion.serverManager.getTpsFactor()))) {
            if (!this.taskList.isEmpty()) {
