...
public class Burrow extends Module
{
    ...
    public void onUpdate() {
        switch (this.mode.getValue()) {
            case OBBY: {
                if (BurrowUtil.findHotbarBlock((Class<? extends Block>)BlockObsidian.class) == -1) {
            ...
            case ECHEST: {
                if (BurrowUtil.findHotbarBlock((Class<? extends Block>)BlockEnderChest.class) == -1) {
            ...
            case EABypass: {
                if (BurrowUtil.findHotbarBlock((Class<? extends Block>)BlockChest.class) == -1) {
        ...
        BurrowUtil.switchToSlot((this.mode.getValue() == Mode.OBBY) ? BurrowUtil.findHotbarBlock((Class<? extends Block>)BlockObsidian.class) : ((this.mode.getValue() == Mode.ECHEST) ? BurrowUtil.findHotbarBlock((Class<? extends Block>)BlockEnderChest.class) : BurrowUtil.findHotbarBlock((Class<? extends Block>)BlockChest.class)));
