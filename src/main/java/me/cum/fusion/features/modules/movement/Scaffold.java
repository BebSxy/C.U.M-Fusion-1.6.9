...
public class Scaffold extends Module
{
    ...
    public Scaffold() {
        ...
        this.swing = (Setting<Boolean>)this.register(new Setting("Swing Arm", (T)true, v -> this.mode.getValue() == Mode.Legit));
        this.bSwitch = (Setting<Boolean>)this.register(new Setting("Switch", (T)true, v -> this.mode.getValue() == Mode.Legit));
        ...
        this.expand = (Setting<Float>)this.register(new Setting("Expand", (T)1.0f, (T)0.0f, (T)6.0f, v -> this.mode.getValue() == Mode.Legit));
    ...
    public void place(final BlockPos posI, final EnumFacing face) {
        ...
        if (Scaffold.mc.gameSettings.keyBindJump.isKeyDown()) {
            ...
            final EntityPlayerSP player = player = Scaffold.mc.player;
            player.motionX *= 0.3;
            final EntityPlayerSP player2;
            final EntityPlayerSP player2 = player2 = Scaffold.mc.player;
            player2.motionZ *= 0.3;
